                ...
                >
                  <p style="margin-bottom: 32px">
                    Omar, <br /> <br />
                     ...
                     } has paused their meal plan for the week of ${
    emailData.weekOf
  }.
                  </p>

                  ${
                    emailData.autoRenewOn
                      ? `
                   <p style="margin-bottom: 32px">
                     Since auto-renew is enabled, their meal plan subscription will renew on 
                     ${emailData.autoRenewChargeDate} for the week of ${emailData.autoRenewWeek}.
                  </p>`
                      : ""
                  }

                  <a
                    href="https://toolbox.vittle.ca/customer/${
