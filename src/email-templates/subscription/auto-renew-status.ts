                ...
                >
                  <p style="margin-bottom: 32px">
                    Omar, <br /> <br />
                     ...
                     } changed their auto-renew preference.
                  </p>
                  ...
                  ${
                    emailData.autoRenew
                      ? `<p style="margin-bottom: 32px">
                  As of next week, subscriptions will begin to subscribe unless otherwise paused or turned off.
                  </p>`
                      : `<p style="margin-bottom: 32px">
                     Their subscription will no longer auto-renew.
                  </p>`
                  }
