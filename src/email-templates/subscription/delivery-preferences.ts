                ...
                >
                  <p style="margin-bottom: 32px">
                    Omar, <br /> <br />
                     ...
                     } changed their delivery preferences.
                  </p>

                   <p style="margin-bottom: 32px">
                     As of next week, their meals will be ${
                       emailData.deliveryType === "delivery"
                         ? "delivered"
                         : "picked up"
                     } the ${
    emailData.deliveryTime === "nightBefore" ? "night before" : "day of"
  }. 
                  </p>
