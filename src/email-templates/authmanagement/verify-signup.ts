export default function welcomeToVittle(emailData: any) {
  return `
            ...
            <tr>
              ...
              >
                ...
                <div class="header-text" style="float: left">
                  ...
                  >
                    ${emailData.firstName}, ${
    emailData.language === "EN" ? "verify your account" : "vérifie ton compte"
  } 
                  </p>
                </div>
              </td>
                ...
                >
                  ...
                  ${
                    emailData.language === "EN"
                      ? `Verify that you want to use ${emailData.email} as your contact email address and username for Vittle.`
                      : `Vérifie que tu veux utiliser ${emailData.email} comme email de contact et comme nom d'utilisateur pour ton compte Vittle.`
                  }
                  </p>

                  <a
                    href="${emailData.token}"
                    style="
                      font-size: 18px;
                      margin: 0 0 0 0;
                      display: inline-block;
