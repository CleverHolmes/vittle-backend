export default function deletedfromVittle(emailData: any) {
                    ...
                    >
                      ...
                      ${emailData.secondary === false
                        ? emailData.language === "EN"
                          ? `Removed Primary account of ${emailData.email} from Vittle.`
                          : `Compte Primaire supprimé de ${emailData.email} de Vittle.`
                        : emailData.language === "EN"
                          ? `Removed account of ${emailData.email} from Vittle.`
                          : `Compte supprimé de ${emailData.email} de Vittle.`
                      }
                      </p>
