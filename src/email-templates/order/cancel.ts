            ...
            <tr>
              <td colspan="2">
                <p
                  ...
                  "
                >
                 We cancelled your order, ${emailData.firstName}
                </p>
                <p
                  style="
                    font-family: Helvetica, Arial, sans-serif;
                  ...
                  "
                >
                   We cancelled your order. You will not be charged for any portion of your order if a temporary hold was placed on your payment method. This is not a charge and should disappear from your bank statement shortly.
                </p>
                <p style="margin-top: 24px; margin-bottom: 6px;font-size: 16px;">
