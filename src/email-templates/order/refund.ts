...
<html lang="en">
  ...
  >
    ...
    <div itemscope itemtype="http://schema.org/EmailMessage">
      ...
      <meta itemprop="description" content="We refunded your Vittle order"/>
    </div>
            ...
            <tr>
              <td colspan="2">
                <p
                  ...
                  "
                >
                  Votre commande a été remboursée, ${emailData.firstName}.
                </p>
                <p
                  style="
                    font-family: Helvetica, Arial, sans-serif;
                  ...
                  "
                >
                 Nous avons remboursé votre commande et vous serez remboursé en utilisant la méthode de paiement originale dans un délai de 3 à 5 jours ouvrables.
                </p>
          ...
          ${
            ...
            <tr style="margin-bottom: 32px">
              ...
              <td>
               ...
               <td align="right">
                <p style="margin-bottom: 32px; margin-top: 0;font-size: 16px;">${currency(
                  emailData.orderLineItems.total,
                  {
                    pattern: "# !",
                    separator: " ",
                    decimal: ",",
          ...
          src="https://beta.vittle.ca/card-icons/${emailData.cardBrand}.png"
                  ...
                  <td align="right">
                    <p
                      ...
                      "
                    >
                      <strong> Remboursé : -${currency(emailData.total, {
                        pattern: "# !",
                        separator: " ",
                        decimal: ",",
                      }).format()}</strong>
        ...
        >
            ...
            <tr>
              <td colspan="2">
                <p
                  ...
                  "
                >
                  Your order has been refunded, ${emailData.firstName}
                </p>
                <p
                  style="
                    font-family: Helvetica, Arial, sans-serif;
                  ...
                  "
                >
                We refunded your order and you will be refunded using the original payment method within 3-5 business days.
                </p>
                <p style="margin-top: 24px; margin-bottom: 6px;font-size: 16px;">
          ...
          ${
           ...
           <tr style="margin-bottom: 32px">
            ...
            <tr style="margin-bottom: 32px">
              <td>
                <p style="margin-bottom: 32px; margin-top: 0; margin-bottom: 0;font-size: 16px; font-weight: bold;">
                  Total
                </p>
        
              </td>
              <td align="right">
                <p style="margin-bottom: 32px; margin-top: 0;font-size: 16px; font-weight: bold;">${currency(
                  emailData.orderLineItems.total
                ).format()}</p>
              </td>
            </tr>
