              ...
              >
                ...
                >
                  <p style="margin-bottom: 32px">
                    ...
                    } gifted ${emailData.recipientFirstName} ${
                      emailData.recipientLastName
                    } with a ${currency(emailData.giftCardAmount).format()} gift card.
                  </p>
                  ...
                  <a
                    href="https://toolbox.vittle.ca/orders/${emailData.orderId}"
                    style="
                      font-size: 18px;
                      margin: 0 0 0 0;
                      display: inline-block;
