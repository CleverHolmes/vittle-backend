...
export default function orderReceiptEmail(emailData: OrderEmailProps) {
  ...
  const renderSelectedExtras = (item: any) => {
    ...
    return item.selectedExtras
      .map((e: any) => {
        return `
        <p style="margin-top: 0; margin-bottom: 0; font-size: 14px; color: #b9b2b6">
          ${e.title}
        </p>`;
      })
      .join("");
  ...
  const orderItemsGrocery = emailData.lineItems
    ...
    .map((e: any) => {
      return `<tr>
          ...
          <td align="right">
            <p style="margin-bottom: 0; margin-top: 0px;font-size: 16px;">${currency(
              e.total
            ).format()}</p>
            <p
              style="
  ...
  const orderItemsMeals = emailData.lineItems
    ...
    .map((e: any) => {
      return `<tr>
          <td>
            ...
            ${renderSelectedExtras(e)}
          </td>
          <td align="right">
            <p style="margin-bottom: 0; margin-top: 0px;font-size: 16px;">

            ${
              emailData.selectedMealPlan !== null &&
              emailData.selectedMealPlanName !== "a-la-carte"
                ? `
              <span style="text-decoration: line-through; font-size: 14px; margin-right: 4px">${currency(
                e.total
              ).format()}</span>
              `
                : ""
            ...
            ${currency(
              emailData.selectedMealPlan !== null &&
                emailData.selectedMealPlanName !== "a-la-carte"
                ? emailData.selectedMealPlan.pricePerMeal
                : e.total
            ).format()}</p>
            <p
              style="
  ...
  >
    ...
    emailData.subjectMealPlanDate !== ""
      ...
      : ""
                ...
                <p style="margin-top: 0; margin-bottom: 6px; font-size: 16px;">
                  <span style="font-weight: bold;font-size: 16px;"> Payment ID:</span>
                 <a href="https://dashboard.stripe.com/payments/${
                   emailData.paymentIntentId
                 }"> ${emailData.paymentIntentId} </a>
                </p>
                ...
                ${
                  emailData.autoRenew
                    ...
                    <p style="margin-top: 0; font-size: 16px;">
                      <span style="font-weight: bold;font-size: 16px;"> Auto-renew:</span>
                      ${emailData.autoRenew ? "On" : "Off"} ${
                        emailData.selectedMealPlanName === "a-la-carte"
                          ? "(À la carte)"
                          : ""
                      }
            ...
            <tr valign="top">
              <td class="delivery-half">
                <p style="line-height: 26px; margin-top: 0; font-weight: bold;font-size: 16px;">
                  ${
                    ...
                    ${
                      emailData.deliveryType === "pickup"
                        ? `<p style="line-height: 26px; font-size: 16px; margin-bottom: 0">
              ...
              ${
                orderItemsGrocery.length > 0 && orderItemsMeals.length == 0
                  ? `
                  <td class="delivery-half">
                    <p style="line-height: 26px; margin-top: 0; font-weight: bold;font-size: 16px;">
                      ${
                 ...
                 orderItemsMeals.length > 0
                  ...
                  <td class="delivery-half">
                    <p style="line-height: 26px; margin-top: 0; font-weight: bold; font-size: 16px;">
                     ...
                     <p style="margin-top: 0; line-height: 26px; font-size: 16px;">
                     ${
                       emailData.deliveryTime === "nightBefore"
                         ? "Night before"
                         : "Day of"
                     }<br /> ${
                       emailData.deliveryTime === "nightBefore"
                         ? "Between 4:30 p.m. to 8:30 p.m."
                         : "Between 7:00 a.m. to 11:00 a.m."
                     }
                    </p>
                  </td>`
                   : ""
            ...
            ${
              emailData.deliveryType !== "pickup"
                ...
                <tr valign="top">
                  <td class="delivery-half">
                    <p style="line-height: 26px; margin-top: 14px; font-weight: bold;font-size: 16px;">
                      Delivery option
                    </p>
                  ...
                  ${
                    ...
                    ${emailData.schedule
                      ?.map(
                        (e: any) =>
                          `<p style="line-height: 26px; margin-top: 0; margin-bottom: 4px; font-size: 16px;">${e}</p>`
                      )
                      .join("")}
                    </td>
                  </tr>`
            ...
            <tr>
              <td colspan="2" style="border-top: 1px solid #ddd">
                <p
                  ...
                  "
                >
                  ${orderItemsMeals.length > 0 ? "Grocery" : "Products"}
                </p>
              </td>
            </tr>
            
            ${orderItemsGrocery.join("")}
          ...
          orderItemsMeals.length > 0
            ...
            <tr style="margin-bottom: 32px;">
              <td style="border-top: 1px solid #ddd">
                ...
                >
                   ${
                     emailData.selectedMealPlanName !== "" &&
                     emailData.selectedMealPlanName !== "a-la-carte"
                       ? "Meal plan"
                       : "Meals"
                   }
              ...
              ${
                ...
                <td align="right" style="border-top: 1px solid #ddd">
                    <p style="margin-bottom: 10px; margin-top: 0px;font-size: 16px; font-weight: bold">
                     ${currency(
          ...
          <tr>
            ...
            <td align="right">
              <p style="margin-bottom: 10px; margin-top: 0px;font-size: 16px;">${currency(
                emailData.orderLineItems.subTotalActual
              ).format()}</p>
            </td>
          </tr> 

          ${
            emailData.orderLineItems.savings > 0
              ? `<tr>
            <td>
              <p style="margin-bottom: 10px; margin-top: 0px;font-size: 16px; color: #4caf50">
                Savings
              </p>
            </td>
            <td align="right">
              <p style="margin-bottom: 10px; margin-top: 0px;font-size: 16px; color: #4caf50">-${currency(
                emailData.orderLineItems.savings
              ).format()}</p>
            </td>
          </tr>
        `
            ...
            ${
              ...
              !emailData.orderLineItems.deliveryFeeOff
                ? `<tr>
                  <td>
                  ...
                  <td align="right">
                    <p style="margin-bottom: 10px; margin-top: 0px;font-size: 16px; ">${currency(
                      emailData.orderLineItems.deliveryFee
                    ).format()}</p>
                  </td>
                </tr>
              `
            ...
            ${
              emailData.orderLineItems.deliveryFeeOff
                ? `<tr>
                  ...
                  <td align="right">
                    <p style="margin-bottom: 10px; margin-top: 0px;font-size: 16px; color: #4caf50">Free</p>
                  </td>
                </tr>
              `
                : ""
            ...
            ${
              emailData.hasExtras
                ? `<tr>
                  ...
                  <td align="right">
                    <p style="margin-bottom: 10px; margin-top: 0px;font-size: 16px; ">${currency(
                      emailData.orderLineItems.extras
                    ).format()}</p>
                  </td>
                </tr>
            `
            ...
            <tr>
              ...
              >
                <p style="margin-bottom: 32px; text-align: center">
                  <a
                    href="https://toolbox.vittle.ca/order/${emailData.orderId}"
                    style="
                      font-size: 18px;
                      margin: 0 0 0 0;
                      display: inline-block;
                ...
                <p style="margin-bottom: 32px; color: rgb(185, 178, 182); text-align: center;">
                ${
                  emailData.autoRenew
                    ? `Meal plan subscriptions auto-renew every Thursday from
