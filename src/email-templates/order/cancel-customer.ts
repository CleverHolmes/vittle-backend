            ...
            <tr>
              <td colspan="2">
                <p
                  ...
                  "
                >
                  Nous avons annulé votre commande, ${emailData.firstName}.
                </p>
                <p
                  style="
                    font-family: Helvetica, Arial, sans-serif;
                  ...
                  "
                >
                Nous avons annulé votre commande. Aucune partie de votre commande ne vous sera facturée.
                </p>
          ...
          src="https://beta.vittle.ca/card-icons/${emailData.cardBrand}.png"
                  ...
                  <td align="right">
                    <p
                      ...
                      "
                    >
                      <strong> Annulé ${currency(emailData.total, {
                        pattern: "# !",
                        separator: " ",
                        decimal: ",",
                      }).format()}</strong>
            ...
            <tr>
              <td colspan="2">
                <p
                  ...
                  "
                >
                 Your order has been cancelled, ${emailData.firstName}
                </p>
                <p
                  style="
                    font-family: Helvetica, Arial, sans-serif;
                  ...
                  "
                >
                   Your order has been cancelled. You will not be charged for any portion of your order if a temporary hold was placed on your payment method. This is not a charge and should disappear from your bank statement shortly.
                </p>
                <p style="margin-top: 24px; margin-bottom: 6px;font-size: 16px;">
