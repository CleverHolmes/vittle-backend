      ...
      <tr>
        ...
        >
          ...
          >
            ...
            <tr>
              <td colspan="2">
                <p
                  ...
                  "
                >
                  ${emailData.firstName} cancelled their order
                </p>

                <p style="margin-top: 24px; margin-bottom: 6px;font-size: 16px;">
                  <span style="font-weight: bold">Cancelled at:</span> ${
                    emailData.cancelledAt
                  }
                </p>
            ...
            <tr valign="top">
              <td>
                <p style="line-height: 26px; margin-top: 24px; font-weight: bold;font-size: 16px;">
                  Comments
                </p>

                <p style="line-height: 26px; margin-top: 0; margin-bottom: 0;font-size: 16px;">
                  ${emailData.cancelNote}
                </p>
              </td>
            </tr>
