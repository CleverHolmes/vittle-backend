...
export default function orderReceiptEmail(emailData: OrderEmailProps) {
  ...
  let deliveryAddress = "";
  let thanksForOrderingSubheading = "";
  ...
  if (
    emailData.orderType === "a-la-carte" ||
    emailData.orderType === "combined"
  ) {
    if (isPickup) {
      thanksForOrderingSubheading =
        "Thank you for your order. We've received your order and will notify you when your products are ready to be picked up";
    } else {
      thanksForOrderingSubheading =
        "Thank you for your order. We've received your order and will notify you when your products are out for delivery by our local courier.";
    }
  }

  if ((emailData.orderType = "mealPlan")) {
    if (emailData.showPaymentHoldMessage) {
      thanksForOrderingSubheading =
        "Thank you for your order. We have received your order and are currently in the process of reviewing it. You will be contacted by email once your order has been processed.";
    } else {
      if (isPickup) {
        thanksForOrderingSubheading =
          "Thank you for your order. We've received your order and will notify you when your products are ready to be picked up";
            ...
            <tr>
              <td colspan="2">
                <p
                  ...
                  "
                >
                  Merci d'avoir commandé, ${emailData.firstName}.
                </p>
                <p
                  style="
                    font-family: Helvetica, Arial, sans-serif;
                  ...
                  "
                >
                  Merci pour votre commande. Nous avons reçu votre commande et
                  nous vous informerons lorsque ${
                    emailData.lineItems.length === 1
                      ? "votre produit"
                      : "vos produits"
                  } seront livrés par notre livreur local.
                </p>
        ...
        >
            ...
            <tr>
              <td colspan="2">
                <p
                  ...
                  "
                >
                  Thanks for ordering, ${emailData.firstName}
                </p>
                <p
                  style=" 
                    font-family: Helvetica, Arial, sans-serif;
          ...
          >
            <tr>
              ...
              ${
                emailData.showPaymentHoldMessage
                  ? `
                <p style="margin-bottom: 40px; color: #aaa;">
